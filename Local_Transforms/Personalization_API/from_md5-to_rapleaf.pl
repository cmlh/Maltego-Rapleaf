...
my $response = query_by_md5($maltego_selected_entity_value);
...
rapleaf-md5-maltego-local-transform.pl - "Rapleaf - MD5 - Maltego Local Transform"

=head1 VERSION

This documentation refers to "Rapleaf - MD5 - Maltego Local Transform" Alpha $VERSION
...
$1 i.e. "MD5" Entity i.e. https://github.com/cmlh/Maltego-Crypto/blob/master/Entities-Crypto.mtgx
...
2. "MD5" Entity i.e. https://github.com/cmlh/Maltego-Crypto/blob/master/Entities-Crypto.mtgx
